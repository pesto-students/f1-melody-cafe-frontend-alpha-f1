import { ToggleButton, Modal, Button, ToggleButtonGroup } from "react-bootstrap";
...
function PaymentModal({ showPayment, setShowPayment }){
   ...
   async function openPayModal(amt){
    ...
    axios.post(`http://localhost:5000/payment?plan=${50000}`)
        .then(res=>{
    ...
    useEffect(()=>{
      ...
      return (
        ...
        <Modal.Body>
            <ToggleButtonGroup type="radio" name ="amount" defaultValue={14900}   onChange={(e) => setValue(e.currentTarget.value)}>
                <div className='plans'>
                <div>
                  <h6>1 Months  149</h6>
