...
const SearchResult = (props) => {
  ...
  if (
    ...
    if (props.selectedSong == null) {
      ...
      if (
        props.selectedSong.snippet.resourceId.videoId ===
        modifiedResult.snippet.resourceId.videoId
      ) {
    ...
    function songSelect() {
      ...
      if (state.shuffleOn) {
        newQueue = shufflePlaylist(newQueue, modifiedResult);
      }
      setState((state) => ({
        ...state,
        currentSong: modifiedResult,
        queue: newQueue,
